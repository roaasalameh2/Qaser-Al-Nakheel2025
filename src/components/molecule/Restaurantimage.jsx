...
const RestaurantImage = ({ isOpen, onClose, mainImageData, restaurantId, imageUrl, secondaryImages }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-admin-color bg-opacity-50 z-[130] text-black ">
      <div className="modal-content bg-admin-color p-6 rounded  border border-sec-color-100 shadow-lg max-w-lg w-full max-h-[90vh] overflow-y-auto ">
        ...
        {/* الصور الثانوية */}
        <div className="mt-6 border-t  border-sec-color-100 p-4">
